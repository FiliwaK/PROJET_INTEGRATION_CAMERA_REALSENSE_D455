...
from hand_detector import HandDetector   # notre classe de détection (mains + corps)
from socket_server import SocketServer   # notre serveur TCP qui envoie les données au C#

# ── Création des objets principaux ──────────────────────────────────────────

# HandDetector : initialise MediaPipe Hands + MediaPipe Pose
...
try:
    while True:
        ...
        # Envoie l'image au détecteur → retourne un dict JSON avec
        # les positions des mains et du corps
